...
def funct_cambiar_direccion(persona:list):
    persona["domicilio"]["calle"] = "Ramon Franco"
    persona["domicilio"]["altura"] = 5050
    print(persona)

def funct_crear_tel_trabajo(persona:list):
    for numeros_tel in persona["telefonos"]:
        if not "trabajo" in numeros_tel["etiqueta"]:
            pass